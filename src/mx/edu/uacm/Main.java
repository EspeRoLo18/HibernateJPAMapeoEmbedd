...
public class Main {
	...
	public static void main(String[] args) {
		...
		//usr1.setId(1L);
		usr1.setNombreUsuario("paco");
		usr1.setMensajeUsuario("Hola");
		usr1.setDireccionCasa(new Direccion("Avenida", "1200", "10,000,000", "CDMX"));
		usr1.setDireccionTrabajo(new Direccion("Avenida", "16776", "10,000,000", "CDMX"));
		...
		usr2.setDireccionTrabajo(new Direccion("Calle", "1780", "12,000,000", "EDOMEX"));
		em.persist(usr2);
